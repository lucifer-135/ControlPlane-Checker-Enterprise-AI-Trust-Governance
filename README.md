...
[![Tests](https://img.shields.io/badge/Tests-74_passed-brightgreen)](<>)
...
- **Linguistic Certainty Extraction**: Scans for high-conviction asserting keywords (_"with 100% legal certainty"_, _"guaranteed"_, _"without a doubt"_, _"strictly mandates"_) versus hedging phrases (_"might be"_, _"according to documentation"_).

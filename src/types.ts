...
export interface DetectedEntity {
  ...
  span_start?: number;
  span_end?: number;
  /** Contextual confidence boost/suppress adjustment from piiContext analysis. */
...
export interface PolicyProfile {
  ...
  maxPipelineLatencyBudgetMs?: number;
}

/** Tracks a single risk event within a session for time-decay compounding. */
...
/** Full session state for exponential time-decay accumulation. */
